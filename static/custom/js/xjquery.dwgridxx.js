    ...
    var methods = {  
        ...
        init : function( options ) { 
                    ...
                    var opt = {           
                        ...
                        form_attr       : 'class="dw-form form-search"',
                        order_attr      : 'class="data-order dw-spinner"',
                    ...
                    return this.each(function(k) {  
                        ...
                        if(opt.form_search) {
                            ...
                            container.find('.btn-actions').prepend('<button class="btn btn-info dw-text-bold btn-form-search"><i class="btn-icon-only icon-search"></i> <span class="hidden-xs">'+translation.ugettext(opt.language,"SEARCH")+'</span></button>');
...
$(function() {  
    ...
    $('body').on('click', '.table-responsive tbody tr', function() {          
        ...
        (accion=='mostrar') ? elem.removeClass('btn-actions').hide().fadeIn(250) : elem.fadeOut(50).addClass('hidden').show();                   
    });
